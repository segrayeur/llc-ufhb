...
const FloatingBubbles = () => {
  ...
  return (
    <>
      {/* Floating Bubbles Container - Fixed position bottom right with horizontal layout */}
        ...
        <div className="relative">
          ...
          <div className="flex items-center space-x-2 bg-background/95 backdrop-blur-xl border border-white/30 rounded-full px-3 py-2 shadow-2xl">
            ...
            <Button
              ...
              className="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white shadow-xl rounded-full transition-all duration-300 hover:scale-110"
              title="Assistant IA"
            >
            ...
            <Button
              ...
              className="w-10 h-10 bg-blue-600 hover:bg-blue-700 text-white shadow-xl rounded-full transition-all duration-300 hover:scale-110"
              title="Téléphone"
            >
            ...
            <Button
              ...
              className="w-10 h-10 bg-red-500 hover:bg-red-600 text-white shadow-xl rounded-full transition-all duration-300 hover:scale-110"
              title="Contact"
            >
            ...
            <Button
              ...
              className="w-10 h-10 bg-green-600 hover:bg-green-700 text-white shadow-xl rounded-full transition-all duration-300 hover:scale-110"
              title="WhatsApp"
            >
